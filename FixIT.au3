...
#AutoIt3Wrapper_Icon=images\Logo\fixit.ico
#AutoIt3Wrapper_Res_Fileversion=2.21.6
...
; Variable Registry
Global $registryFixITFolder = "HKEY_CURRENT_USER\Software\FixIT"
...
Func ScriptLogin()
    ; [Login]
    If RegRead($registryFixITFolder, $registryFirstLoginKey) Then
    Else
            ...
            Switch GUIGetMsg()
                ...
                Case $buttonLogin
                    ...
                    If $sUsername = "FixIT" And $sPassword = "1234" Then
                        RegWrite($registryFixITFolder, $registryFirstLoginKey, "REG_DWORD", 1)
...
If RegRead($registryFixITFolder, "") = "" Then
